...
#define _MICRO_MENU_H_
	 ...
	 */
	#define MENU_ITEM(Name, Next, Previous, Parent, Child, SelectFunc, EnterFunc, Pointer, Text) \
		extern Menu_Item_t Next;     \
		extern Menu_Item_t Previous; \
		extern Menu_Item_t Parent;   \
		extern Menu_Item_t Child;  \
		Menu_Item_t Name = {&Next, &Previous, &Parent, &Child, SelectFunc, EnterFunc, Pointer, Text}
